"""
Datos de municipios de Colombia con códigos DANE oficiales.
Fuente: DANE - Divipola (División Político-Administrativa de Colombia)
Actualizado: 2024

Estructura: Lista de tuplas (código_dane, nombre_municipio, departamento)
El código DANE tiene 5 dígitos: 2 para departamento + 3 para municipio
"""
...
MUNICIPIOS_COLOMBIA = [
    ...
    ("05237", "Donmatías", "Antioquia"),
    ("05240", "Ebéjico", "Antioquia"),
    ("05250", "El Bagre", "Antioquia"),
    ("05264", "Entrerríos", "Antioquia"),
    ...
    ("05647", "San Andrés de Cuerquia", "Antioquia"),
    ...
    ("05664", "San Pedro de los Milagros", "Antioquia"),
    ("05665", "San Pedro de Urabá", "Antioquia"),
    ("05667", "San Rafael", "Antioquia"),
    ("05670", "San Roque", "Antioquia"),
    ("05674", "San Vicente Ferrer", "Antioquia"),
    ...
    ("15332", "Güicán de la Sierra", "Boyacá"),
    ("15362", "Iza", "Boyacá"),
    ...
    ("20443", "Manaure Balcón del Cesar", "Cesar"),
    ...
    ("23586", "Purísima de la Concepción", "Córdoba"),
    ...
    ("25328", "Guayabal de Síquima", "Cundinamarca"),
    ...
    ("25843", "Villa de San Diego de Ubaté", "Cundinamarca"),
    ...
    ("47660", "Sabanas de San Ángel", "Magdalena"),
    ...
    ("54003", "Ábrego", "Norte de Santander"),
    ...
    ("54128", "Cáchira", "Norte de Santander"),
    ...
    ("70823", "San Antonio de Palmito", "Sucre"),
...
DEPARTAMENTOS_COLOMBIA = sorted(list(set([m[2] for m in MUNICIPIOS_COLOMBIA])))

def get_municipios_por_departamento(departamento: str) -> list:
    """Obtener todos los municipios de un departamento específico."""
    return [(code, name) for code, name, dept in MUNICIPIOS_COLOMBIA if dept == departamento]

def get_municipio_por_codigo(codigo: str) -> tuple:
    """Obtener información de un municipio por su código DANE."""
    for code, name, dept in MUNICIPIOS_COLOMBIA:
        if code == codigo:
